...
classifier.fit_generator(
        training_set,
        steps_per_epoch=310, #number of images in training set
        epochs=25,
        validation_data=test_set,
        validation_steps=48, #number of images in test set
        workers = 12,
        max_queue_size = 100) 
    

classifier.save('bird_model.h5')

'''
#Making new predictions
import numpy as np
from keras.preprocessing import image
test_image = image.load_img('dataset2/single_prediction/Rufous_Hummingbird_0016_59660.jpg', target_size = (64, 64)) #second argument is target size
